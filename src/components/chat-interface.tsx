...
export function ChatInterface() {
  ...
  const executeSpell = (content: string) => {
    const result: ExecutionResult = {
      ...
      response: 'Spell execution succeeded. This is a sample response from the spell execution.',
      ui: (
        ...
        <AlertDialogContent className="bg-black border-2 border-white text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-white/80">
              This spell costs {selectedSpell?.cost} credits. Do you want to proceed with the
              execution?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
